...
using System.IO;
using TiaanOdendaal.ServiceReference1;
...
namespace TiaanOdendaal
{
    public partial class ClientService : System.Web.UI.Page
    {
        ...
        protected void getClients()
        {
            ...
            BL.Client[] ClientList = client.GetClients(0);
        ...
        protected void getClientData(int clientID)
        {
            ...
            ServiceReference1.Service1Client client = new ServiceReference1.Service1Client();
            BL.Client[] ClientList = client.GetClients(clientID);
        ...
        protected void ListAddresses(int ClientID)
        {
            ...
            ServiceReference1.Service1Client client = new ServiceReference1.Service1Client();
            BL.Address[] AddressList = client.GetAddresses(ClientID,0);
        ...
        protected void btnAddClient_Click(object sender, EventArgs e)
        {
            ...
            //bool userin = db.SaveClient(clientID, txtFirstName.Text, txtLastName.Text, SelectedGender, txtEmail.Text, ClientBirthCalendar1.Text);
            int userin = client.SaveClient(clientID, txtFirstName.Text, txtLastName.Text, SelectedGender, txtEmail.Text, ClientBirthCalendar1.Text);
        ...
        protected void RradAddressList_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            BL.Address[] AddressList = client.GetAddresses(Convert.ToInt32(hdnClientID.Value), AddressID);
        ...
        protected void btnSaveAddress_Click(object sender, EventArgs e)
        {
            ...
            bool addrin = client.SaveAddress(addressid, txtAddress1.Text, txtAddress2.Text, txtSuburb.Text, txtCity.Text, Convert.ToInt32(radAddressType.SelectedValue), clientid);
            if (addrin)
            {
                hdnAddres.Value = "0";
                clearAddress();
        ...
        protected void btnExportAll_Click(object sender, EventArgs e)
        {
            ...
            //MyFirstWCFServiceClient client = new MyFirstWCFServiceClient();
            //Client[] ClientList = client.GetClients();
            //ClientData db = new ClientData();
            ServiceReference1.Service1Client client = new ServiceReference1.Service1Client();
            BL.Client[] ClientList = client.GetClients(0);
            foreach (BL.Client WriteClient in ClientList)
            {
                ...
                // Address[] AddresList = client.GetAddresses(WriteClient.ID);
                //AddressData dbA = new AddressData();
                BL.Address[] AddresList = client.GetAddresses(WriteClient.ID, 0);
                int AddressCount = 0;
